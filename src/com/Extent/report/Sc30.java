...
public class Sc30 {
	...
	public static void main(String[] args) throws IOException
	{
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("E:\\SeleniumProject\\BlueStone\\Reports\\sc30.html");
			...
			test.addScreenCaptureFromPath("E:\\SeleniumProject\\BlueStone\\Captureimages\\s30.png");
